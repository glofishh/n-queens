...
window.findSolution = function(row, n, board, validator, callback) {
  // if all rows exhausted, this is valid solution
  if (row === n) {
    return callback();
  }
...
window.findRooksSolution = function(n) {
...
//return a matrix (Array of arrays) representing a single nxn chessboard, with n queens placed such that none of them can attack each other
window.findNQueensSolution = function(n) {
  ...
  //if no solution exists, return original unaltered board
